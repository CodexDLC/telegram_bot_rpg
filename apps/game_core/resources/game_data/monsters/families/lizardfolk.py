...
LIZARDFOLK_FAMILY: MonsterFamily = {
    ...
    "variants": {
        # --- 1. Мелкая чешуя (Minions) [Tier 2-5] ---
        "skink_scout": {
            "id": "skink_scout",
            "role": "minion",
            "cost": 20,
        ...
        "bog_trotter": {
            ...
            "min_tier": 2,
            "max_tier": 5,
            "narrative_hint": "A common lizardman with a crude spear. At home in the swamp.",
        ...
        # --- 2. Опытные бойцы (Veterans) [Tier 2-6] ---
        "saurian_warrior": {
            "id": "saurian_warrior",
            "role": "veteran",
            "cost": 50,
