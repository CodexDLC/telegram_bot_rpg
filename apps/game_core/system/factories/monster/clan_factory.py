...
from apps.common.database.repositories import MonsterRepository
from apps.common.schemas_dto.monster_dto import MonsterFamilyDTO, MonsterVariantDTO
from apps.common.services.gemini_service.gemini_service import gemini_answer
from apps.game_core.resources.game_data.monsters import (
    get_available_variants_for_tier,
    get_family_config,
)
from apps.game_core.resources.game_data.monsters.spawn_config import (
    BIOME_FAMILIES,
    TIER_AVAILABILITY,
    TIER_SCALING_CONFIG,
)
from apps.game_core.system.factories.monster.clan_hashing import (
