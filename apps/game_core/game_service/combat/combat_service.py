...
from apps.game_core.game_service.combat.combat_ai_service import CombatAIService
...
from apps.game_core.game_service.combat.combat_turn_manager import CombatTurnManager
