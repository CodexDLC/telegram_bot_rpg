# apps/game_core/modules/combat/supervisor/task_dispatcher.py
...
class LocalAsyncioDispatcher:
    ...
    async def dispatch_check(self, session_id: str) -> None:
        ...
        supervisor = CombatSupervisor(session_id, self.combat_manager, self.account_manager, self.context_manager)
