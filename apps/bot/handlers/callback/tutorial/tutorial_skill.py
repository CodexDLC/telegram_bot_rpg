# LEGACY CODE
# MARKED: Uses non-InGame state: StartTutorial, CharacterLobby
import asyncio
...
from apps.bot.resources.fsm_states.states import CharacterLobby, StartTutorial
from apps.bot.resources.keyboards.callback_data import TutorialQuestCallback
