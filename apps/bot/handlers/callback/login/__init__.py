...
from .login_handler import router as login_handler_router  # <--- НОВЫЙ РОУТЕР
from .logout import router as logout_router

login_router_group = Router(name="login_group")

login_router_group.include_routers(
    lobby_router, char_creation_router, logout_router, lobby_character_selection_router, login_handler_router
)
