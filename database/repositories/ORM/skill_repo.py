...
from database.model_orm.skill import CharacterSkillProgress, CharacterSkillRate, SkillProgressState
...
class SkillRateRepo(ISkillRateRepo):
    ...
    async def get_all_skill_rates(self, character_id: int, **kwargs: Any) -> list[SkillRateDTO]:
...
class SkillProgressRepo(ISkillProgressRepo):
    ...
    async def get_all_skills_progress(self, character_id: int, **kwargs: Any) -> list[SkillProgressDTO]:
