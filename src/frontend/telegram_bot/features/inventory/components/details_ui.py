...
from src.frontend.telegram_bot.features.inventory.resources.keyboards.callbacks import (
    InventoryActionCB,
    InventoryViewCB,
)
from src.shared.enums.inventory_enums import InventoryActionType, InventoryViewTarget
from src.shared.schemas.inventory import DetailsContextDTO, InventoryUIPayloadDTO
