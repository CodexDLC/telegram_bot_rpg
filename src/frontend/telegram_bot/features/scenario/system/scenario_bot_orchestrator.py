...
from src.frontend.bot.resources.fsm_states.states import BotState as GameState
...
from src.frontend.telegram_bot.features.scenario.system.scenario_ui_service import ScenarioUIService
...
from src.shared.schemas.user import UserDTO as User
