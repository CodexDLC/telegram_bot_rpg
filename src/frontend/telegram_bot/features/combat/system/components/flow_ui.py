...
from src.frontend.telegram_bot.features.combat.resources.formatters.combat_formatters import CombatFormatter
from src.frontend.telegram_bot.features.combat.resources.keyboards.combat_callback import CombatFlowCallback
...
class CombatFlowUI:
    ...
    async def render_spectator_mode(self, snapshot: CombatDashboardDTO) -> ViewResultDTO:
        ...
        from src.frontend.telegram_bot.features.combat.resources.keyboards.combat_callback import CombatMenuCallback
