# game_client/telegram_bot/features/exploration/system/components/navigation_ui.py

from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup
from aiogram.utils.keyboard import InlineKeyboardBuilder

from common.schemas.exploration import AlertHudDTO, ExplorationHudDTO, GridButtonDTO, WorldNavigationDTO
from game_client.telegram_bot.base.view_dto import ViewResultDTO
from game_client.telegram_bot.features.exploration.resources.keyboards.exploration_callbacks import (
    EncounterCallback,
    NavigationCallback,
)
