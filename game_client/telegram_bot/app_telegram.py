# game_client/telegram_bot/app_telegram.py
"""
...
from game_client.telegram_bot.core.factory import build_bot
from game_client.telegram_bot.core.routers import main_router
...
async def main() -> None:
    ...
    from game_client.telegram_bot.middlewares import (
        ContainerMiddleware,
        SecurityMiddleware,
