...
from game_client.bot.resources.keyboards.callback_data import MeinMenuCallback
...
from game_client.bot.ui_service.mesage_menu.menu_service import MenuService
