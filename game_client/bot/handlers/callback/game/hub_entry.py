...
from game_client.bot.resources.keyboards.callback_data import ServiceEntryCallback
...
from game_client.bot.ui_service.hub_entry_service import HubEntryService
