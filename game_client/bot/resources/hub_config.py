...
from game_client.bot.resources.fsm_states import BotState
from game_client.bot.ui_service.arena_ui_service.arena_ui_service import ArenaUIService
from game_client.bot.ui_service.helpers_ui.stub_service import StubUIService
...
HUB_CONFIGS: dict[str, HubConfig] = {
    ...
    "svc_town_hall_hub": {
        "title": "Ратуша",
        "intro_text": "",
        "fsm_state": BotState.exploration,  # ИСПРАВЛЕНО: InGame.exploration
