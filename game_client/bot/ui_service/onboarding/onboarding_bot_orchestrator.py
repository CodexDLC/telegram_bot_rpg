...
from game_client.bot.core_client.onboarding_client import OnboardingClient
...
from game_client.bot.ui_service.onboarding.onboarding_ui_service import OnboardingUIService
