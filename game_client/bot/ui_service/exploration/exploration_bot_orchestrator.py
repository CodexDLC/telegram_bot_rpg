...
from game_client.bot.core_client.combat_rbc_client import CombatRBCClient
...
from game_client.bot.ui_service.exploration.dto.exploration_view_dto import ExplorationViewDTO
