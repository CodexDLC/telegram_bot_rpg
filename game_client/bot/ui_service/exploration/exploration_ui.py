...
from game_client.bot.ui_service.exploration.encounter_ui import EncounterUI
from game_client.bot.ui_service.exploration.navigation_ui import NavigationUI
