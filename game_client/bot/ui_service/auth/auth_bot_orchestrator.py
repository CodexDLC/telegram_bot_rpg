...
# from apps.common.schemas_dto.game_state_enum import CoreDomain, GameState
...
#         if game_stage != CoreDomain.ONBOARDING:
#             menu_service = MenuService(
#                 game_stage=game_stage
#                 if game_stage != CoreDomain.COMBAT
...
#         elif game_stage in ("in_game", "world", CoreDomain.EXPLORATION) or (
#             isinstance(login_result, tuple) and login_result[0] in ("in_game", "world", CoreDomain.EXPLORATION)
#         ):
