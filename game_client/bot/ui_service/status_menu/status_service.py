...
from game_client.bot.resources.status_menu.bio_group_data import BIO_HIERARCHY, TABS_NAV_DATA
...
from game_client.bot.ui_service.status_menu.formatters.status_formatters import StatusFormatter as StatusF
