from game_client.bot.core_client.arena_client import ArenaClient
from game_client.bot.core_client.exploration import ExplorationClient
from game_client.bot.ui_service.arena_ui_service.arena_ui_service import ArenaUIService
from game_client.bot.ui_service.arena_ui_service.dto.arena_view_dto import ArenaViewDTO
...
class ArenaBotOrchestrator:
    ...
    async def leave_arena(self, char_id: int, state_data: dict) -> ArenaViewDTO:
        ...
        if loc_dto:
            from game_client.bot.ui_service.exploration.exploration_ui import ExplorationUIService
