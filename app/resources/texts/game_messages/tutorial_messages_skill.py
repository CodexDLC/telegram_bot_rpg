...
Твоя стратегия?"""
        ...
        "step_3": {  # Сцены Боя (Лог + 1 кнопка)
            "reflexes": {
                "combat_log": [
                    "[БОЙ]: Химера срывается с места, молниеносно сокращая дистанцию!",
                    "[БОЙ]: Ты полагаешься на свои РЕФЛЕКСЫ. В последний момент ты делаешь резкий рывок в сторону, пропуская удар мимо себя.",
                    "[БОЙ]: Враг открыт! Ты наносишь точный контрудар в незащищенный бок. ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
            "intuition": {
                "combat_log": [
                    "[БОЙ]: Хищник напрягся, готовясь к прыжку.",
            ...
            "arcane_magic": {
                "combat_log": [
                    "[БОЙ]: Химера атакует, ее когти вспарывают воздух!",
                    "[БОЙ]: Ты УСИЛИВАЕШЬ КЛИНОК магией. Лезвие вспыхивает синим пламенем.",
                    "[БОЙ]: Твой удар встречается с ее атакой и разрубает врага надвое! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
            "shield": {
                "combat_log": [
                    "[БОЙ]: Мощный удар Химеры-Джаггернаута обрушивается на тебя!",
                    "[БОЙ]: Ты крепко стоишь на ногах и принимаешь удар на ЩИТ. Раздается оглушительный грохот.",
                    "[БОЙ]: Враг на мгновение теряет равновесие от собственной силы. Ответный удар! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
            "fortitude": {
                "combat_log": [
                    "[БОЙ]: Удар Химеры сотрясает тебя до костей!",
                    "[БОЙ]: Твоя СТОЙКОСТЬ и толстая броня выдерживают. Ты едва пошатнулся.",
                    "[БОЙ]: Ты игнорируешь боль и пробиваешься сквозь ее защиту! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
            "persistence": {
                "combat_log": [
                    "[БОЙ]: Химера атакует, ты атакуешь в ответ. Вы обмениваетесь ударами.",
                    "[БОЙ]: Враг рычит от боли, но и ты чувствуешь, как трещит броня. Твоя НАСТОЙЧИВОСТЬ заставляет тебя идти вперед.",
                    "[БОЙ]: Ты сражаешь ее на чистой воле! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            }
        }
...
несется Химера-кабан с огромными клыками! Твоя тактика?"""
        ...
        "step_3": { # Сцены Боя (Лог + 1 кнопка)
             "reflexes": {
                "combat_log": [
                    "[БОЙ]: Химера пикирует / несется на тебя! Земля дрожит!",
                    "[БОЙ]: Ты используешь РЕФЛЕКСЫ, отпрыгивая в сторону в последний момент.",
                    "[БОЙ]: Враг проносится мимо. В развороте ты делаешь точный выстрел! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
            "intuition": {
                "combat_log": [
                    "[БОЙ]: Химера несется прямо на тебя!",
                    "[БОЙ]: Твоя ИНТУИЦИЯ находит идеальный момент... Ты натягиваешь тетиву, время замедляется.",
                    "[БОЙ]: Выстрел! Стрела попадает точно в глаз / под крыло! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
             "air_magic": {
                "combat_log": [
                    "[БОЙ]: Крылатая Химера пикирует с небес, готовя когти!",
                    "[БОЙ]: Ты инстинктивно взываешь к магии и создаешь ПОТРЫВ ВЕТРА, сбивая ее с курса.",
                    "[БОЙ]: Пока она дезориентирована, ты делаешь прицельный выстрел! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            },
             "fortitude": {
                "combat_log": [
                    "[БОЙ]: Химера-кабан врезается в тебя! Удар такой силы, что ты летишь кубарем!",
                    "[БОЙ]: Твоя СТОЙКОСТЬ и кольчуга спасают тебя от переломов. Ты быстро вскакиваешь.",
                    "[БОЙ]: Химера разворачивается... но ты уже готов. Выстрел в упор! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_LOOTING": "[Собрать добычу]" }
            }
            #... (другие тактики для Ranged)
        }
    },  # end ranged branch
...
Она — воплощение парадокса. Какой аспект реальности ты выберешь?"""
        ...
        "step_3": { # Сцены Боя (Лог + 1 кнопка)
            "fire_magic": {
                "combat_log": [
                    "[БОЙ]: Химера Ветра и Пламени атакует, выпуская стену огня!",
                    "[БОЙ]: ОГОНЬ против ОГНЯ! Ты высвобождаешь свой собственный, более концентрированный поток.",
                    "[БОЙ]: Твоя магия чище и сильнее. Она поглощает пламя Химеры и ее саму! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_MAGIC": "[Поглотить эссенцию]" }
            },
            "water_magic": {
                "combat_log": [
                    "[БОЙ]: Огненная часть Химеры вспыхивает, готовясь испепелить тебя!",
                    "[БОЙ]: Ты инстинктивно призываешь силу ВОДЫ. Ледяной поток обрушивается на элементаля.",
                    "[БОЙ]: Раздается оглушительное шипение! Пар! Огонь гаснет, ветер стихает. Химера ослаблена и рассеивается! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_MAGIC": "[Поглотить эссенцию]" }
            },
            # ... (earth_magic, air_magic) ...
            "arcane_magic": {
                "combat_log": [
                    "[БОЙ]: Химера Света и Тьмы нестабильна, она пульсирует, искажая реальность.",
                    "[БОЙ]: Ты видишь ее суть. ТАЙНАЯ МАГИЯ (Arcane) — это сама структура. Ты тянешь за 'нити'.",
            ...
            "light_magic": {
                "combat_log": [
                    "[БОЙ]: Химера атакует тебя потоком чистой, удушающей Тьмы!",
                    "[БОЙ]: Твой СВЕТ вспыхивает, как маяк. Ты направляешь очищающий луч прямо в сердце тени.",
                    "[БОЙ]: Тьма отступает, не в силах вынести твое сияние. Свет очищает аномалию! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_MAGIC": "[Поглотить эссенцию]" }
            },
            "dark_magic": {
                "combat_log": [
                    "[БОЙ]: Химера атакует ослепляющим, болезненным Светом!",
                    "[БОЙ]: Ты призываешь ТЬМУ. Она не злая, она — покой. Тень накрывает тебя, поглощая атаку.",
                    "[БОЙ]: Свет Химеры гаснет в твоей всепоглощающей тени. Она рассеивается! ПОБЕДА!"
                ],
                "buttons": { "finale:FINALE_MAGIC": "[Поглотить эссенцию]" }
            }
            #... (другие стихии/аспекты)
        }
    },  # end magic branch
