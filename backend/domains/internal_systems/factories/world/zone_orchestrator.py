...
from backend.domains.internal_systems.factories.monster.clan_factory import ClanFactory
from backend.domains.internal_systems.factories.world.content_gen_service import (
    ContentGenerationService,
)
from backend.domains.internal_systems.factories.world.threat_service import ThreatService
from backend.resources.game_data.graf_data_world.world_config import (
    ANCHORS,
    HUB_CENTER,
    REGION_ROWS,
    REGION_SIZE,
