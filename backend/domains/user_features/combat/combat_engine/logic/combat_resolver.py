...
from backend.domains.user_features.combat.combat_engine.logic.math_core import MathCore
from backend.domains.user_features.combat.dto.combat_actor_dto import ActorStats
from backend.domains.user_features.combat.dto.combat_pipeline_dto import (
    CombatEventDTO,
    InteractionResultDTO,
    PipelineContextDTO,
)
from backend.resources.game_data.triggers.definitions.rules import TRIGGER_RULES_DICT
