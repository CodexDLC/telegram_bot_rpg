...
from backend.resources.game_data.skills.definitions.armor import ARMOR_SKILLS
from backend.resources.game_data.skills.definitions.combat_support import COMBAT_SUPPORT_SKILLS
from backend.resources.game_data.skills.definitions.crafting import CRAFTING_SKILLS
from backend.resources.game_data.skills.definitions.gathering import GATHERING_SKILLS
from backend.resources.game_data.skills.definitions.social import SOCIAL_SKILLS
from backend.resources.game_data.skills.definitions.survival import SURVIVAL_SKILLS
from backend.resources.game_data.skills.definitions.tactical import TACTICAL_SKILLS
from backend.resources.game_data.skills.definitions.trade import TRADE_SKILLS

# Импорт определений
from backend.resources.game_data.skills.definitions.weapon_mastery import WEAPON_MASTERY_SKILLS
