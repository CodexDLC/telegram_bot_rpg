...
from backend.resources.game_data.gifts.definitions.darkness import DARKNESS_GIFTS
from backend.resources.game_data.gifts.definitions.fire import FIRE_GIFTS
from backend.resources.game_data.gifts.definitions.light import LIGHT_GIFTS
from backend.resources.game_data.gifts.definitions.nature import NATURE_GIFTS
from backend.resources.game_data.gifts.definitions.water import WATER_GIFTS
from backend.resources.game_data.gifts.schemas import GiftDTO, GiftSchool
from backend.resources.game_data.gifts.xp_config import GIFT_LEVELING
