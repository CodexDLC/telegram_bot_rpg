...
## 🔮 Backlog
- [ ] **[Risk & Reward System](../../../../../management/task/Task_Risk_Reward_Implementation.md)** (Механика смерти и потери лута).
- [ ] **[Settlement System v3.1](./Task_Settlement_Architecture.md)** (Доработка системы завершения боя и истории).
- [ ] Групповые бои (Конфигурация и UI).
- [ ] Система петов (Интеграция с Inventory/Pets).
