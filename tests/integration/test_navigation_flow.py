...
#         # ИСПРАВЛЕНО: Используем BotState.lobby вместо CharacterLobby.selection
#         await fsm_context.set_state(BotState.lobby)
#
#         # ==========================================
#         # 1. ВХОД В ИГРУ (LOGIN)
#         # ==========================================
...
#         assert current_state == BotState.exploration, f"Ожидался InGame.exploration, получен {current_state}"
